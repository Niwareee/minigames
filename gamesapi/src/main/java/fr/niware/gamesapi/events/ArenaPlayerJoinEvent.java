...
public class ArenaPlayerJoinEvent<T extends AbstractPlayer<U>, U extends Arena<T>> extends Event {
    ...
    public ArenaPlayerJoinEvent(T abstractPlayer) {
    ...
    public HandlerList getHandlers() {
        return ArenaPlayerJoinEvent.HANDLERS_LIST;
    }

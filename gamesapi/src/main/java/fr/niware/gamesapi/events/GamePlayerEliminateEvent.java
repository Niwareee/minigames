...
public class GamePlayerEliminateEvent<T extends AbstractPlayer<U>, U extends Arena<?>> extends Event {
    ...
    public GamePlayerEliminateEvent(T abstractPlayer) {
    ...
    public HandlerList getHandlers() {
        return GamePlayerEliminateEvent.HANDLERS_LIST;
    }
